      ...
      <header className="sticky top-0 z-20 bg-amber-50/90 backdrop-blur border-b border-stone-200">
        <div className="max-w-6xl mx-auto px-6 py-4 flex items-center justify-between">
          <button onClick={goHome} className="flex items-center gap-2.5 group">
            <span className="w-9 h-9 rounded-xl bg-blue-950 flex items-center justify-center transition-transform duration-300 group-hover:scale-105 group-hover:rotate-3">
              <Home className="w-5 h-5 text-amber-400" strokeWidth={2.5} />
            </span>
            <span className="font-bold text-lg tracking-tight" style={{ fontFamily: "'Fraunces', serif" }}>Afri<span className="text-amber-600">Nest</span></span>
          </button>
        ...
        <>
          <section className="relative overflow-hidden">
            <div className="absolute inset-0">
              ...
              />
              <div className="absolute inset-0 bg-gradient-to-b from-blue-950/85 via-blue-950/75 to-amber-50" />
            </div>
            <div className="relative max-w-6xl mx-auto px-6 pt-16 pb-20">
              <div className="max-w-2xl animate-[fadeInUp_0.7s_ease-out]">
                <span className="inline-block text-xs font-bold tracking-widest uppercase text-amber-400 mb-3">Togo · Afrique de l'Ouest</span>
                <h1 className="text-4xl md:text-5xl leading-[1.1] font-semibold text-white" style={{ fontFamily: "'Fraunces', serif" }}>
          ...
          <section id="annonces" className="max-w-6xl mx-auto px-6 pb-16">
            <Reveal>
              <div className="flex items-end justify-between mb-6">
                ...
                <button onClick={loadListings} className="text-sm font-semibold text-amber-600 hover:text-amber-700 transition-colors">Rafraîchir</button>
              </div>
            </Reveal>
              ...
              <div className="grid md:grid-cols-3 gap-6">
                {steps.map((s, i) => (
                  <Reveal key={i} delay={i * 130}>
                    <div className="relative h-full bg-white/[0.06] border border-white/10 rounded-2xl p-6 backdrop-blur-sm hover:bg-white/[0.1] hover:border-amber-600/40 hover:-translate-y-1 transition-all duration-300 group">
                      <span className="absolute top-5 right-5 text-4xl font-bold text-white/10 select-none" style={{ fontFamily: "'Fraunces', serif" }}>
                        0{i + 1}
                      </span>
                      <div className="w-14 h-14 rounded-2xl bg-amber-600/20 flex items-center justify-center transition-transform duration-300 group-hover:scale-110 group-hover:rotate-3">
